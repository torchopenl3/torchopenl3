...
class PytorchOpenl3(nn.Module):
    def __init__(self, input_repr, embedding_size, weight_file):
        ...
        self.AUDIO_POOLING_SIZES = {'linear': {512: (32, 24), 6144: (8, 8)},
        ...
        n_hop = 242
        asr = 48000
        self.malspeclayer = Spectrogram.MelSpectrogram(sr=asr, n_fft=n_dft, n_mels=n_mels, hop_length=n_hop, window='hann', center=True,
                                                       pad_mode='reflect', power=1.0, htk=False, fmin=0.0, fmax=None, norm=1, trainable_mel=False,
        ...
        self.audio_embedding_layer = self.__conv(
            2, name='audio_embedding_layer', in_channels=512, out_channels=512, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=True)
    ...
    def forward(self, x):
        ...
        max_pooling2d_1 = F.max_pool2d(activation_2, kernel_size=(
        ...
        max_pooling2d_2 = F.max_pool2d(activation_4, kernel_size=(
            2, 2), stride=(2, 2), padding=0, ceil_mode=False)
        ...
        max_pooling2d_3 = F.max_pool2d(activation_6, kernel_size=(
            2, 2), stride=(2, 2), padding=0, ceil_mode=False)
        ...
        max_pooling2d_4 = F.max_pool2d(audio_embedding_layer, kernel_size=self.AUDIO_POOLING_SIZES[self.input_repr][
                                       self.embedding_size], stride=self.AUDIO_POOLING_SIZES[self.input_repr][self.embedding_size], padding=0, ceil_mode=False)
